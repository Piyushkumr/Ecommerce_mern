...
exports.updateProfile = catchAsyncErrors(async (req, res, next) => {
    ...
    if (req.files && req.files.avatar) {
        ...
        console.log("Received file:", req.files?.avatar);
        console.log("Uploaded to Cloudinary:", myCloud);
...
exports.deleteUser = catchAsyncErrors(async (req, res, next) => {
    ...
    if (!user) {
        return next(new ErrorHandler(`User does not found ${req.params.id}`, 400));
    }
